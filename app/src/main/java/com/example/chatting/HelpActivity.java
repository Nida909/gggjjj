...
public class HelpActivity extends AppCompatActivity {
    String[] problems={"Create My Account","Log In","Nearest Milk Man","Chat Box","Giving Review", "Placing Order","Rider Selection","Update Information"};
    ...
    String[] prblem={"اکاؤنٹ","لاگ ان","دودھ کا آدمی","چیٹ باکس","جائزہ", "بکنگ آرڈر","رائڈر","معلومات"};
    Context context;
    Resources resources;
    String languages,lang,search;
    ImageButton img;
    EditText question;
    TextView text;
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
       ...
       // search=question.getText().toString();
...
question.setHint("یہاں تلاش کریں");
           ...
           // question.setTypeface(createFromAsset(getAssets(),"urdufont.ttf"));
            //question.setInputType();
           // question.setText("ur text");
...
String optn=" ";
        if (languages.equals("ENGLISH")) {
            ...
            switch (optn) {
                ...
                case "Create My Account":
                    ...
                    break;
                case "Log In":
                    Intent intent1 = new Intent(HelpActivity.this, LogIn.class);
                    lang = "ENGLISH";
                ...
                case "Rider Selection":
                    ...
                    break;
                default:
                    Toast.makeText(HelpActivity.this,"Sorry! No answer found",Toast.LENGTH_SHORT).show();
        ...
        if (languages.equals("اردو")) {
            String opt=" ";
            search = question.getText().toString();
            for( int i=0; i<prblem.length;i++)
            {
                if(search.contains(prblem[i]))
                {
                    opt=prblem[i];
                }
            }
